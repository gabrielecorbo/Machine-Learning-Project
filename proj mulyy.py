...
encoder2.fit(y_mc_training)
encoded_Y_t = encoder2.transform(y_mc_training)
# convert integers to dummy variables (i.e. one hot encoded)
dummy_y_train = np_utils.to_categorical(encoded_Y_t)

history=model.fit(X_train_pol, dummy_y_train, epochs=100, batch_size=10,validation_split=0.15)
